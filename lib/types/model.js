...
var Model = module.exports = function (name, definition, models) {
  ...
  this.models = models || {};
	// OutSystems change: from Inline Model to Array
...
Model.schemaToJSON = function (schema, models, modelsToIgnore) {
  var type = schema.type || 'object';
  var model;
  var output;
    ...
    if (schema.$ref) {
      ...
      if (!_.isUndefined(model)) {
        if (_.isUndefined(modelsToIgnore[model.name])) {
          ...
          output = Model.schemaToJSON(model.definition, models, modelsToIgnore);
      ...
      _.forEach(schema.properties, function (property, name) {
        output[name] = Model.schemaToJSON(property, models, modelsToIgnore);
      });
    } else if (type === 'array') {
      output = [];
      ...
      if (_.isArray(schema.items)) {
        _.forEach(schema.items, function (item) {
          output.push(Model.schemaToJSON(item, models, modelsToIgnore));
        });
      } else if (_.isPlainObject(schema.items)) {
        output.push(Model.schemaToJSON(schema.items, models, modelsToIgnore));
...
Model.prototype.createJSONSample = Model.prototype.getSampleValue = function (modelsToIgnore) {
  ...
  return Model.schemaToJSON(this.definition, this.models, modelsToIgnore);
};
